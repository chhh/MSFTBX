...
public class ResourceUtils {
     ...
     * @param resourceLocation  This is the `package` or `directory` where the resource resides. This normally will be
     *                          a subfolder of `test/resources`.
     ...
     */
    public static Path getResource(Class<?> clazz, String resourceLocation, String resourceName) throws Exception {
    ...
    public static List<Path> getResources(Class<?> clazz, String resourceLocation) {
        try {
            ...
            throw new IllegalStateException(String.format(
                    "Could not get a list of resources for class `%s`, location `%s`", clazz.getSimpleName(), resourceLocation));
        }
