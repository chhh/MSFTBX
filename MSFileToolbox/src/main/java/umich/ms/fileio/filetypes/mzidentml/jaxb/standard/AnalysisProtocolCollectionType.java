...
public class AnalysisProtocolCollectionType {
   ...
   * there is not a <CODE>set</CODE> method for the spectrumIdentificationProtocol property.
   *
   * <p>
   ...
   *
   * <p>
   * Objects of the following type(s) are allowed in the list {@link SpectrumIdentificationProtocolType
   * }
   */
   ...
   *
   * @return possible object is {@link ProteinDetectionProtocolType }
   */
   ...
   *
   * @param value allowed object is {@link ProteinDetectionProtocolType }
   */
