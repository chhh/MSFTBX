...
public class ReferenceableParamGroupListType {
   ...
   * there is not a <CODE>set</CODE> method for the referenceableParamGroup property.
   *
   * <p>
   ...
   *
   * <p>
   * Objects of the following type(s) are allowed in the list {@link ReferenceableParamGroupType }
   */
