...
public class ProteinDetectionListType
   ...
   * there is not a <CODE>set</CODE> method for the proteinAmbiguityGroup property.
   *
   * <p>
   ...
   *
   * <p>
   * Objects of the following type(s) are allowed in the list {@link ProteinAmbiguityGroupType }
   */
  ...
  /**
   * Scores or output parameters associated with the whole ProteinDetectionList Gets the value of
