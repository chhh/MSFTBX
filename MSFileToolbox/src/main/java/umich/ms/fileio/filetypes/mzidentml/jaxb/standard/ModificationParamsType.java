...
/**
 * The specification of static/variable modifications (e.g. Oxidation of Methionine) that are to be
 * considered in the spectra search.
 *
...
public class ModificationParamsType {
   ...
   * there is not a <CODE>set</CODE> method for the searchModification property.
   *
   * <p>
   ...
   *
   * <p>
   * Objects of the following type(s) are allowed in the list {@link SearchModificationType }
   */
