...
public class IsotopicContributions {
   ...
   * there is not a <CODE>set</CODE> method for the contributingChannel property.
   *
   * <p>
   ...
   *
   * <p>
   * Objects of the following type(s) are allowed in the list {@link ContributingChannel }
   */
