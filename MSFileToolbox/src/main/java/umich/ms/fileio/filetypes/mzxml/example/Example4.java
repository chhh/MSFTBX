...
public class Example4 {
  ...
  public static void main(String[] args) throws FileParsingException {
    ...
    System.out
        .printf("The data is loaded and used by [%s] object.\n", System.identityHashCode(dataUser));
    ...
    scans.setDefaultStorageStrategy(
        StorageStrategy.SOFT); // mz-intensity data will be softly referenced
    ...
    for (Map.Entry<Integer, IScan> scanEntry : scanEntries) {
      ...
      System.out
          .printf("Scan #%d (raw #%d) contained %d data points\n", scanNumInternal, scanNumRaw,
              numPoints);
    }
