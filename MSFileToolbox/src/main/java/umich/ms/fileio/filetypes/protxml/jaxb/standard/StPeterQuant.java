...
public class StPeterQuant {
   ...
   * there is not a <CODE>set</CODE> method for the stPeterQuantPeptide property.
   *
   * <p>
   ...
   *
   * <p>
   * Objects of the following type(s) are allowed in the list {@link StPeterQuantPeptide }
   */
