...
public class ModificationInfo {
    ...
    protected List<AminoacidSubstitution> aminoacidSubstitution;
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link AminoacidSubstitution }
     * 
     * 
     */
    public List<AminoacidSubstitution> getAminoacidSubstitution() {
        if (aminoacidSubstitution == null) {
            aminoacidSubstitution = new ArrayList<AminoacidSubstitution>(1);
        }
