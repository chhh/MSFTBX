...
/**
 * Description of a particular hardware configuration of a mass spectrometer. Each configuration
 * must have one (and only one) of the three different components used for an analysis. For hybrid
 * instruments, such as an LTQ-FT, there must be one configuration for each permutation of the
 * components that is used in the document. For software configuration, use a
...
public class InstrumentConfigurationType
   ...
   *
   * @param value allowed object is {@link ComponentListType }
   */
   ...
   *
   * @param value allowed object is {@link SoftwareRefType }
   */
