...
public class Peptide {
   ...
   * This accessor method returns a reference to the live list, not a snapshot. Therefore any
   * modification you make to the returned list will be present inside the JAXB object. This is why
   * there is not a <CODE>set</CODE> method for the modificationInfo property.
   *
   * <p>
   * For example, to add a new item, do as follows:
   * <pre>
   ...
   *
   * <p>
   * Objects of the following type(s) are allowed in the list {@link ModificationInfo }
   */
   ...
   * This accessor method returns a reference to the live list, not a snapshot. Therefore any
   * modification you make to the returned list will be present inside the JAXB object. This is why
   * there is not a <CODE>set</CODE> method for the peptideParentProtein property.
   *
   * <p>
   * For example, to add a new item, do as follows:
   * <pre>
   ...
   *
   * <p>
   * Objects of the following type(s) are allowed in the list {@link PeptideParentProtein }
   */
   ...
   * This accessor method returns a reference to the live list, not a snapshot. Therefore any
   * modification you make to the returned list will be present inside the JAXB object. This is why
   * there is not a <CODE>set</CODE> method for the indistinguishablePeptide property.
   *
   * <p>
   * For example, to add a new item, do as follows:
   * <pre>
   ...
   *
   * <p>
   * Objects of the following type(s) are allowed in the list {@link IndistinguishablePeptide }
   */
