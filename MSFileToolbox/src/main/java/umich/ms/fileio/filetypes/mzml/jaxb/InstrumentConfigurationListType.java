...
/**
 * List and descriptions of instrument configurations. At least one instrument configuration must be
 * specified, even if it is only to specify that the instrument is unknown. In that case, the
 * "instrument model" term is used to indicate the unknown instrument in the
...
public class InstrumentConfigurationListType {
   ...
   * there is not a <CODE>set</CODE> method for the instrumentConfiguration property.
   *
   * <p>
   ...
   *
   * <p>
   * Objects of the following type(s) are allowed in the list {@link InstrumentConfigurationType }
   */
