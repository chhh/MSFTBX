...
/**
 * Contains the types of measures that will be reported in generic arrays for each
 * SpectrumIdentificationItem e.g. product ion m/z, product ion intensity, product ion m/z error
 *
