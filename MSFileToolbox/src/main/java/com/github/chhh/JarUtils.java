...
public class JarUtils {
  ...
  public static Path unpackFromJar(String resourceLocation, boolean randomizeName,
      boolean scheduleForDeletion, String fileNameEndingMarker) throws IOException {

    return unpackFromJar(JarUtils.class, resourceLocation, randomizeName, scheduleForDeletion, fileNameEndingMarker);
  }
  ...
  public static Path unpackFromJar(Class<?> clazz, String resourceLocation,
      boolean randomizeName, boolean scheduleForDeletion, String fileNameEndingMarker) throws IOException {

    try (InputStream in = clazz.getResourceAsStream(resourceLocation)) {
      final String resourceNameDest = computeFinalResourceName(resourceLocation, fileNameEndingMarker);
  ...
  public static Path unpackFromJar(Class<?> clazz, String resourceLocation, Path locationInTemp,
      boolean maintainRelLoc, boolean scheduleForDeletion, String fileNameEndingMarker) throws IOException {
  ...
  private static String computeFinalResourceName(String resourceLocation, String fileNameEndingMarker) {
    final String resourceNameOrig = StringUtils.afterLastChar(resourceLocation, '/', false);
    return resourceNameOrig.toLowerCase().endsWith(fileNameEndingMarker)
