...
public class ActivationInfo {
  ...
  /**
   * Either the beginning of the collision energy ramp or just the collision energy. In
   * electronvolts.
   */
  ...
  /**
   * This would mean different things for different activation methods and might not be present most
   * of the time.
   */
  ...
  public String toString() {
    if (activationTime == null) {
      return String.format("Activation:%s@[%.2f-%.2f]", activationMethod, activationEnergyLo,
          activationEnergyHi);
    } else {
      return String
          .format("Activation:%s@[%.2f-%.2f] for %.2f", activationMethod, activationEnergyLo,
              activationEnergyHi, activationTime);
    }
  }
}
