...
public interface IScanCollection extends Serializable {
     ...
     * of this interface. Default is STRONG. Users should be able to configure this
     * property after calling the constructor, but before loading any data from
     * an {@link LCMSDataSource}.
     */
     ...
     * @param storageStrategy spectral storage strategy, can be null, in which case the default storage strategy of the
     *              underlying ScanCollection should be used
     ...
     * @param exlude a set of LCMSDataSubsets to be excluded from the unloading
     * operation
     */
