...
public class ZlibInflater {
    ...
    /**
     * The ByteArrayHolder pool, that this decoder is using. If you use uncompression methods from this class,
     * e.g. {@link #zlibUncompressBuffer(byte[], int, Integer)}, you will need to return the ByteArrayHolder, that
     * was returned to you, into that pool.
     * @return
     */
     ...
     */
    public static ByteArrayHolder zlibUncompressBuffer(byte[] compressed, Integer uncompressedLen) throws
     ...
     * @throws umich.ms.fileio.exceptions.FileParsingException
     */
    public static ByteArrayHolder zlibUncompressBuffer(byte[] bytes, int length, Integer uncompressedLen) throws
            IOException, DataFormatException, FileParsingException {
