...
/**
 * The analyses performed to get the results, which map the input and output data sets. Analyses are
 * for example: SpectrumIdentification (resulting in peptides) or ProteinDetection (assemble
...
public class AnalysisCollectionType {
   ...
   * there is not a <CODE>set</CODE> method for the spectrumIdentification property.
   *
   * <p>
   ...
   *
   * <p>
   * Objects of the following type(s) are allowed in the list {@link SpectrumIdentificationType }
   */
   ...
   *
   * @return possible object is {@link ProteinDetectionType }
   */
   ...
   *
   * @param value allowed object is {@link ProteinDetectionType }
   */
