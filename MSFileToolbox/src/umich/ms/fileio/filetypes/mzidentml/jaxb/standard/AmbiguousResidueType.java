...
/**
 * Ambiguous residues e.g. X can be specified by the Code attribute and a set of parameters for
 * example giving the different masses that will be used in the search.
 *
...
public class AmbiguousResidueType {
  ...
  /**
   * Parameters for capturing e.g. "alternate single letter codes"Gets the value of the paramGroup
   * property.
   *
   * <p>
