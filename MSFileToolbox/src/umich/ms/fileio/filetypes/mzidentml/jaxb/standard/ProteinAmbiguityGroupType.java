...
/**
 * A set of logically related results from a protein detection, for example to represent conflicting
 * assignments of peptides to proteins.
 *
 *
...
public class ProteinAmbiguityGroupType
   ...
   * there is not a <CODE>set</CODE> method for the proteinDetectionHypothesis property.
   *
   * <p>
   ...
   *
   * <p>
   * Objects of the following type(s) are allowed in the list {@link ProteinDetectionHypothesisType
   * }
   */
  ...
  /**
   * Scores or parameters associated with the ProteinAmbiguityGroup.Gets the value of the paramGroup
   * property.
   *
   * <p>
   * This accessor method returns a reference to the live list, not a snapshot. Therefore any
