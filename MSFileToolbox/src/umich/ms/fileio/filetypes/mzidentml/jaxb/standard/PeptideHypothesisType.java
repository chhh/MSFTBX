...
/**
 * Peptide evidence on which this ProteinHypothesis is based by reference to a PeptideEvidence
 * element.
 *
...
public class PeptideHypothesisType {
   ...
   * there is not a <CODE>set</CODE> method for the spectrumIdentificationItemRef property.
   *
   * <p>
   ...
   *
   * <p>
   * Objects of the following type(s) are allowed in the list {@link SpectrumIdentificationItemRefType
   * }
   */
