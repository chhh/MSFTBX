...
public class AnalysisSoftwareListType {
   ...
   * there is not a <CODE>set</CODE> method for the analysisSoftware property.
   *
   * <p>
   ...
   *
   * <p>
   * Objects of the following type(s) are allowed in the list {@link AnalysisSoftwareType }
   */
