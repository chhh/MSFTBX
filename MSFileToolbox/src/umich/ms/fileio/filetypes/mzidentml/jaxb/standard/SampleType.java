...
/**
 * A description of the sample analysed by mass spectrometry using CVParams or UserParams. If a
 * composite sample has been analysed, a parent sample should be defined, which references
 * subsamples. This represents any kind of substance used in an experimental workflow, such as whole
...
public class SampleType
   ...
   * there is not a <CODE>set</CODE> method for the contactRole property.
   *
   * <p>
   ...
   *
   * <p>
   * Objects of the following type(s) are allowed in the list {@link ContactRoleType }
   */
   ...
   * This accessor method returns a reference to the live list, not a snapshot. Therefore any
   * modification you make to the returned list will be present inside the JAXB object. This is why
   * there is not a <CODE>set</CODE> method for the subSample property.
   *
   * <p>
   * For example, to add a new item, do as follows:
   * <pre>
   ...
   *
   * <p>
   * Objects of the following type(s) are allowed in the list {@link SubSampleType }
   */
