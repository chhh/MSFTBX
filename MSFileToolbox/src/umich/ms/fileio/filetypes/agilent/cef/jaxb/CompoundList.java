 ...
 *       &lt;/sequence>
 *       &lt;attribute name="instrumentConfiguration" type="{http://www.w3.org/2001/XMLSchema}anySimpleType" />
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
 * </pre>
...
public class CompoundList {
   ...
   * there is not a <CODE>set</CODE> method for the compound property.
   *
   * <p>
   ...
   *
   * <p>
   * Objects of the following type(s) are allowed in the list {@link Compound }
   */
  public List<Compound> getCompound() {
    if (compound == null) {
      compound = new ArrayList<Compound>(1);
    }
