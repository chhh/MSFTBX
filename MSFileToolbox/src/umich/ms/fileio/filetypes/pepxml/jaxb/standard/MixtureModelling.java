...
public class MixtureModelling {
   ...
   * there is not a <CODE>set</CODE> method for the mixturemodelDistributionOrMixturemodel
   * property.
   *
   * <p>
   ...
   *
   * <p>
   * Objects of the following type(s) are allowed in the list {@link MixturemodelDistribution }
   * {@link Mixturemodel }
   */
