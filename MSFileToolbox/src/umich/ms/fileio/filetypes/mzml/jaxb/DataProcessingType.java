...
public class DataProcessingType {
   ...
   * there is not a <CODE>set</CODE> method for the processingMethod property.
   *
   * <p>
   ...
   *
   * <p>
   * Objects of the following type(s) are allowed in the list {@link ProcessingMethodType }
   */
