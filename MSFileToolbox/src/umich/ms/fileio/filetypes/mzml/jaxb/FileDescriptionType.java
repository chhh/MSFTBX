...
/**
 * Information pertaining to the entire mzML file (i.e. not specific to any part of the data set) is
 * stored here.
 *
...
public class FileDescriptionType {
   ...
   *
   * @param value allowed object is {@link SourceFileListType }
   */
   ...
   * there is not a <CODE>set</CODE> method for the contact property.
   *
   * <p>
