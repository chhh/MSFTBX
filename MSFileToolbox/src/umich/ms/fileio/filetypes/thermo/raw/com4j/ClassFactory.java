...
public abstract class ClassFactory {
  ...
  public static umich.ms.fileio.filetypes.thermo.raw.com4j.IXRawfile createMSFileReader_XRawfile() {
    return COM4J.createInstance( umich.ms.fileio.filetypes.thermo.raw.com4j.IXRawfile.class, "{1D23188D-53FE-4C25-B032-DC70ACDBDC02}" );
  }
  ...
  public static umich.ms.fileio.filetypes.thermo.raw.com4j.IXVirMS createMSFileReader_XVirMS() {
    return COM4J.createInstance( umich.ms.fileio.filetypes.thermo.raw.com4j.IXVirMS.class, "{6F2F5BD9-1C11-4CBC-AF0D-6DE0E3B06E3B}" );
  }
  ...
  public static umich.ms.fileio.filetypes.thermo.raw.com4j.IXVirUV createMSFileReader_XVirUV() {
    return COM4J.createInstance( umich.ms.fileio.filetypes.thermo.raw.com4j.IXVirUV.class, "{B3DB6431-A183-43F1-8BBD-F354064D9041}" );
  }
}
