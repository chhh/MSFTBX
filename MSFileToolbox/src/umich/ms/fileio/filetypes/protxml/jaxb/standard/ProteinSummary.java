...
public class ProteinSummary {
   ...
   *
   * @return possible object is {@link ProteinSummaryHeader }
   */
   ...
   *
   * @param value allowed object is {@link ProteinSummaryHeader }
   */
   ...
   * This accessor method returns a reference to the live list, not a snapshot. Therefore any
   * modification you make to the returned list will be present inside the JAXB object. This is why
   * there is not a <CODE>set</CODE> method for the proteinGroup property.
   *
   * <p>
   * For example, to add a new item, do as follows:
   * <pre>
   ...
   *
   * <p>
   * Objects of the following type(s) are allowed in the list {@link ProteinGroup }
   */
