...
@XmlType(name = "ProteinDetectionType", namespace = "http://psidev.info/psi/pi/mzIdentML/1.2", propOrder = {
    ...
    extends ProtocolApplicationType
{
    ...
    @XmlElement(name = "InputSpectrumIdentifications", namespace = "http://psidev.info/psi/pi/mzIdentML/1.2", required = true)
