...
@XmlType(name = "AnalysisDataType", namespace = "http://psidev.info/psi/pi/mzIdentML/1.2", propOrder = {
    "spectrumIdentificationList",
    "proteinDetectionList"
})
public class AnalysisDataType {

    @XmlElement(name = "SpectrumIdentificationList", namespace = "http://psidev.info/psi/pi/mzIdentML/1.2", required = true)
    protected List<SpectrumIdentificationListType> spectrumIdentificationList;
    @XmlElement(name = "ProteinDetectionList", namespace = "http://psidev.info/psi/pi/mzIdentML/1.2")
