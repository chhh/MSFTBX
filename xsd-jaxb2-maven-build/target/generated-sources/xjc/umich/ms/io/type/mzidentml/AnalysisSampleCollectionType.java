...
@XmlType(name = "AnalysisSampleCollectionType", namespace = "http://psidev.info/psi/pi/mzIdentML/1.2", propOrder = {
    "sample"
})
public class AnalysisSampleCollectionType {

    @XmlElement(name = "Sample", namespace = "http://psidev.info/psi/pi/mzIdentML/1.2", required = true)
