...
@XmlType(name = "SpectrumIdentificationProtocolType", namespace = "http://psidev.info/psi/pi/mzIdentML/1.2", propOrder = {
    "searchType",
    ...
    extends IdentifiableType
{
    ...
    @XmlElement(name = "SearchType", namespace = "http://psidev.info/psi/pi/mzIdentML/1.2", required = true)
    protected ParamType searchType;
    @XmlElement(name = "AdditionalSearchParams", namespace = "http://psidev.info/psi/pi/mzIdentML/1.2")
    protected ParamListType additionalSearchParams;
    @XmlElement(name = "ModificationParams", namespace = "http://psidev.info/psi/pi/mzIdentML/1.2")
    protected ModificationParamsType modificationParams;
    @XmlElement(name = "Enzymes", namespace = "http://psidev.info/psi/pi/mzIdentML/1.2")
    protected EnzymesType enzymes;
    @XmlElement(name = "MassTable", namespace = "http://psidev.info/psi/pi/mzIdentML/1.2")
    protected List<MassTableType> massTable;
    @XmlElement(name = "FragmentTolerance", namespace = "http://psidev.info/psi/pi/mzIdentML/1.2")
    protected ToleranceType fragmentTolerance;
    @XmlElement(name = "ParentTolerance", namespace = "http://psidev.info/psi/pi/mzIdentML/1.2")
    ...
    @XmlElement(name = "DatabaseFilters", namespace = "http://psidev.info/psi/pi/mzIdentML/1.2")
    protected DatabaseFiltersType databaseFilters;
    @XmlElement(name = "DatabaseTranslation", namespace = "http://psidev.info/psi/pi/mzIdentML/1.2")
