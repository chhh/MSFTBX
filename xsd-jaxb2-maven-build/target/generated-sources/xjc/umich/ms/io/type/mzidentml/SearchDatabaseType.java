...
@XmlType(name = "SearchDatabaseType", namespace = "http://psidev.info/psi/pi/mzIdentML/1.2", propOrder = {
    "databaseName",
    "cvParam"
})
    ...
    extends ExternalDataType
{
    ...
    @XmlElement(name = "DatabaseName", namespace = "http://psidev.info/psi/pi/mzIdentML/1.2", required = true)
