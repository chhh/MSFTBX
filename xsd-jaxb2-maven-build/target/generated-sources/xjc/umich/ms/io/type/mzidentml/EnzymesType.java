...
@XmlType(name = "EnzymesType", namespace = "http://psidev.info/psi/pi/mzIdentML/1.2", propOrder = {
    "enzyme"
})
public class EnzymesType {

    @XmlElement(name = "Enzyme", namespace = "http://psidev.info/psi/pi/mzIdentML/1.2", required = true)
