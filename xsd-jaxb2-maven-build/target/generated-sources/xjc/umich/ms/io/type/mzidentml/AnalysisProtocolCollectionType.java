...
@XmlType(name = "AnalysisProtocolCollectionType", namespace = "http://psidev.info/psi/pi/mzIdentML/1.2", propOrder = {
    "spectrumIdentificationProtocol",
    "proteinDetectionProtocol"
})
public class AnalysisProtocolCollectionType {

    @XmlElement(name = "SpectrumIdentificationProtocol", namespace = "http://psidev.info/psi/pi/mzIdentML/1.2", required = true)
    protected List<SpectrumIdentificationProtocolType> spectrumIdentificationProtocol;
    @XmlElement(name = "ProteinDetectionProtocol", namespace = "http://psidev.info/psi/pi/mzIdentML/1.2")
