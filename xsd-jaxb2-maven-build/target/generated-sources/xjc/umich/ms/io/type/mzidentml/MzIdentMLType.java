...
@XmlType(name = "MzIdentMLType", namespace = "http://psidev.info/psi/pi/mzIdentML/1.2", propOrder = {
    "cvList",
    ...
    extends IdentifiableType
{
    ...
    @XmlElement(name = "AnalysisSoftwareList", namespace = "http://psidev.info/psi/pi/mzIdentML/1.2")
    protected AnalysisSoftwareListType analysisSoftwareList;
    @XmlElement(name = "Provider", namespace = "http://psidev.info/psi/pi/mzIdentML/1.2")
    protected ProviderType provider;
    @XmlElement(name = "AuditCollection", namespace = "http://psidev.info/psi/pi/mzIdentML/1.2")
    protected AuditCollectionType auditCollection;
    @XmlElement(name = "AnalysisSampleCollection", namespace = "http://psidev.info/psi/pi/mzIdentML/1.2")
    protected AnalysisSampleCollectionType analysisSampleCollection;
    @XmlElement(name = "SequenceCollection", namespace = "http://psidev.info/psi/pi/mzIdentML/1.2")
    protected SequenceCollectionType sequenceCollection;
    @XmlElement(name = "AnalysisCollection", namespace = "http://psidev.info/psi/pi/mzIdentML/1.2", required = true)
    protected AnalysisCollectionType analysisCollection;
    @XmlElement(name = "AnalysisProtocolCollection", namespace = "http://psidev.info/psi/pi/mzIdentML/1.2", required = true)
    protected AnalysisProtocolCollectionType analysisProtocolCollection;
    @XmlElement(name = "DataCollection", namespace = "http://psidev.info/psi/pi/mzIdentML/1.2", required = true)
    protected DataCollectionType dataCollection;
    @XmlElement(name = "BibliographicReference", namespace = "http://psidev.info/psi/pi/mzIdentML/1.2")
